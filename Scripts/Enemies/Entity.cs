...
public class Entity : MonoBehaviour
{
    ...
    public bool wallCollision()
    {
        ...
        {
            return Physics2D.Raycast(new Vector2(boxCollider.bounds.max.x, boxCollider.bounds.center.y), new Vector2(transform.localScale.x, 0), wallCheck, wallLayer);
        }
        else
        {
            return Physics2D.Raycast(new Vector2(boxCollider.bounds.min.x, boxCollider.bounds.center.y), new Vector2(transform.localScale.x, 0), wallCheck, wallLayer);
        }
    }
